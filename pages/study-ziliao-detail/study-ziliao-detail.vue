...
<!-- 			 		<u-button :custom-style="customStyle" type="error"  size="small" text="举报"></u-button -->
		  	...
		  	<view style="display: flex;padding: 10rpx 0;border-bottom:2px solid #127c72;margin-bottom: 40rpx;" class="">
		  		<text style="font-size: 28rpx;margin-right: 20rpx;color:#215fa5;font-weight: bold;">资料名:</text>
		  	...
		  	<view style="display: flex; flex-direction: column;">
		  	  ...
		  	  <!-- 详细内容 -->
		  	  <view style="font-size: 28rpx; margin-right: 20rpx; color: #215fa5; font-weight: bold;">详细内容:</view>
