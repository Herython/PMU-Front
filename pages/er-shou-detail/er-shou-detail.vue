...
<!-- 			 		<u-button :custom-style="customStyle" type="error"  size="small" text="举报"></u-button> -->
		  	...
		  	<view style="display: flex;padding: 10rpx 0;border-bottom:2px solid #127c72;margin-bottom: 40rpx;" class="">
		  		<text style="font-size: 28rpx;margin-right: 20rpx;color:#215fa5;font-weight: bold;">物品名称:</text>
		  		<text style="font-size: 30rpx;font-weight: bold;">{{this.item.title}}</text>
		  	</view>
		  	<!-- <view style="display: flex;justify-content: center;padding: 10rpx 0;border-bottom:2px solid #127c72;margin-bottom: 40rpx;" class="">
		  	   <viw>
				   <u-avatar shape="square" size="150rpx" src="https://img01.yzcdn.cn/vant/cat.jpeg"></u-avatar>
				
			   </viw>
		  	</view> -->
		  	<view style="display: flex;padding: 10rpx 0;border-bottom:2px solid #127c72;margin-bottom: 40rpx;" class="">
		  		<text style="font-size: 28rpx;margin-right: 20rpx;color:#215fa5;font-weight: bold;">价格:</text>
		  		<text style="font-size: 36rpx;font-weight: bold;color: red;">{{this.item.count}} <text style="color: black;margin-left: 20rpx;">RMB</text></text>
		  	</view>
				...
				uni.request({
				    ...
				    success: function (res) {
				        ...
				        if (res.statusCode === 200) {
							...
							self.getMessages();
							// uni.navigateTo({
							// 	url:'/pages/life-daiqu-detail/life-daiqu-detail'+'?item='+encodeURIComponent(JSON.stringify(self.item)) 
							// });
